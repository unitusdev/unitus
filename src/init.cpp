...
std::string HelpMessage(HelpMessageMode hmm)
{
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 50603 or testnet: 60603)") + "\n";
    ...
    strUsage += "  -algo=<algo>           " + _("Mining algorithm: argon2d, blake, lyra2re2, skein, qubit, yescrypt, X11") + "\n";

    strUsage += "\n" + _("RPC server options:") + "\n";
    strUsage += "  -server                " + _("Accept command line and JSON-RPC commands") + "\n";
    strUsage += "  -rpcuser=<user>        " + _("Username for JSON-RPC connections") + "\n";
    strUsage += "  -rpcpassword=<pw>      " + _("Password for JSON-RPC connections") + "\n";
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 50604 or testnet: 60604)") + "\n";
