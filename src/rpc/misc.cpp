...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"     (string, required) The unitus address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"address\", (string) The unitus address validated\n"
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"UPSSGeFHDnKNxiEyFrD1wcEaHr9hrQDDWc\"")
            + HelpExampleRpc("validateaddress", "\"UPSSGeFHDnKNxiEyFrD1wcEaHr9hrQDDWc\"")
        );
...
UniValue createmultisig(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            + HelpExampleCli("createmultisig", "2 \"[\\\"UPSSGeFHDnKNxiEyFrD1wcEaHr9hrQDDWc\\\",\\\"UaRxGqA4KK5EK7UP75ni3emNy4vfVv1qcs\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("createmultisig", "2, \"[\\\"UPSSGeFHDnKNxiEyFrD1wcEaHr9hrQDDWc\\\",\\\"UaRxGqA4KK5EK7UP75ni3emNy4vfVv1qcs\\\"]\"")
        ;
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The unitus address to use for the signature.\n"
            ...
            + HelpExampleCli("signmessage", "\"UaRxGqA4KK5EK7UP75ni3emNy4vfVv1qcs\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"UaRxGqA4KK5EK7UP75ni3emNy4vfVv1qcs\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"UaRxGqA4KK5EK7UP75ni3emNy4vfVv1qcs\", \"signature\", \"my message\"")
        );
...
UniValue echo(const JSONRPCRequest& request)
{
    if (request.fHelp)
        throw runtime_error(
            ...
            "unitus-cli and the GUI. There is no server-side difference."
        );
