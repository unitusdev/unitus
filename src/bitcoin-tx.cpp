...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s unitus-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  unitus-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded unitus transaction") + "\n" +
              "  unitus-tx [options] -create [commands]   " + _("Create hex-encoded unitus transaction") + "\n" +
              "\n";
